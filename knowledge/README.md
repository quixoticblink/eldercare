...
Past the first HMW reframe (Jun 25), a partner-anchored narrowing (Jul 8) and its correction three days later (Jul 11). Phase: **v1.8 shipped, two design decisions and Table Top Exercise round 2 next**. Vanguard is the anchor partner as of Jul 8 — a Pasir Ris ICCP-layered pilot offered by year-end. Devil's advocate is active on all three of the recent moves.
...
**As of Sep 11:** a second beta session, at Lions Befrienders, on the v1.7 app — [[journal/2026-09-11-lions-befrienders-beta]] (draft; more feedback arriving). The register [[prototype/lions-befrienders-2026-09-11-feedback]] marks 14 of the first 26 items as already shipped; the new asks are a caregiver with many seniors, hiding names and numbers between kaki and family, urgent visits longer than two hours, and a service-mismatch bug in manual matching.

**As of Sep 20:** v1.8 is live — the small half of the Lions Befrienders list (the matching bug, urgent durations, plainer screens); [[journal/2026-09-20-v1.8-build]]. The big half (a caregiver with many seniors, what each side sees of the other, a danger alert) now leads [[prototype/roadmap]]. Phase: **v1.8 shipped, two design decisions and round 2 next.**
