...
> **Superseded in places (2026-08-09).** This section is the v1 snapshot and is kept as the record of what shipped on 21 July. Since then: sign-in takes email *or* mobile (v1.2), the chatbot tries Anthropic then OpenAI then the keyword guide, and the smoke test is at 156 assertions and counts itself. Current state is [[kakis-app]]; current contract is `app/SPEC.md`.
