...
cd app && npx playwright test              # 37 end-to-end specs (English and Chinese) against a throwaway backend on :8100
```
...
**Status:** v1.8, live, hardened, 415 smoke assertions plus a 37-spec Playwright suite (English and Chinese) (`cd app && npm i && npx playwright test`) covering the full lifecycle. Fit for a **supervised tabletop**, which is exactly what NCSS and Vanguard asked for on Aug 3. Not fit for unsupervised public launch — backups have never been restore-tested, there's no PDPA review or user-facing deletion path, and the pricing is still placeholder.
...
- ✅ Beta session at Lions Befrienders (Sep 11, 2026) — second group, on v1.7; a matching bug, befrienders-of-many, hide names and numbers. [journal/2026-09-11-lions-befrienders-beta.md](knowledge/journal/2026-09-11-lions-befrienders-beta.md).
- ✅ Build round v1.8 (Sep 20, 2026) — the small half of that list: service-mismatch guard, urgent durations, plainer screens. 5 more Playwright specs (37), smoke 415. [journal/2026-09-20-v1.8-build.md](knowledge/journal/2026-09-20-v1.8-build.md). Live.
- ☐ Two design decisions before v1.9: many seniors per caregiver; what each side sees of the other. [prototype/roadmap.md](knowledge/prototype/roadmap.md).
- ☐ Table Top Exercise, round 2 — same group, on v1.8, to validate the changes. NCSS/Care Corner's own session still to be arranged.
- ☐ Demo Day (September 2026) — pilot design + pitch.

**Current phase:** v1.8 shipped, two design decisions and Table Top Exercise round 2 next. **Anchor partner:** Vanguard (MOH Holdings), convened by NCSS. **Current HMW:** [reframing/hmw-current.md](knowledge/reframing/hmw-current.md). **Live app:** [singaporekakis.com](https://singaporekakis.com).
