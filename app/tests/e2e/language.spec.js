...
const LEAKS = /Welcome to Kakis|Send my code|\bSign in\b|Check again|Who are you caring for\?|\bContinue\b|Save care plan|Caring for|Book a visit|What do they need|\bWhen\?|The details|Request this visit|Finding a kaki|Kaki assigned|\bConfirmed\b|Happening now|\bCompleted\b|\bCancelled\b|Check it's them|Start code|Estimated cost|Family pays|Visit report|Private care note|Your visits|Accept this visit|I'm on my way|Start the visit|Start visit|End the visit|Complete visit|Your report|Flag a concern|My profile|Save profile|When I'm free|Different on a date|Skip for now|Add a certificate|certificates are optional|Show cost|Hide cost|Nothing to do right now|Care plan|Your profile|Current visits|\bRecent\b|Step \d of \d|Usually matched|Kaki arrived|\bRequested\b|\bHome\b|\bVisits\b|\bImpact\b|\bProfile\b|Sign out|Your code for the family|On the way|\bHistory\b|Certificates|Payouts|My impact|Add a certificate|Day off|My normal week/;
